  ...
  // }
       var ctx = document.getElementById('myChart').getContext('2d');
                var myChart = new Chart(ctx, {
                    type: 'bar',
                    data: {
                        labels: ['Html', 'Css', 'Js', 'Arduino', 'Cordova', 'C & C++','IoT'],
                        datasets: [{
                            label: 'Skill Level',
                            data: [90, 90, 60, 80, 70, 85,95],
                            backgroundColor: [
                                'rgba(255, 99, 132, 0.2)',
                                'rgba(54, 162, 235, 0.2)',
                                'rgba(255, 206, 86, 0.2)',
...
// var music1 =0;
         function music(){
              ...
              var url = ["https://abegroups.com", "https://sanjaisak.github.io/Baby-mointoring/","https://sanjaisak.github.io/kuthuvilaku/","https://sanjaisak.github.io/CAM_check/", "https://aberesearchlabs.com/#home"];
